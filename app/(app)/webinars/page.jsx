...
const featuredWebinar = {
  ...
  speaker: "Deepanshu Jha",
  role: "Founder, vFulfill",
  videoUrl: "https://d24fzeiqvvundc.cloudfront.net/media_uploads/04f7bda332c76acff66fbee3bab6c67e.mp4",
  duration: "45:12",
  views: "1.2k",
  rating: "4.9"
};
...
const pastWebinars = [
  { 
    title: "Mastering Facebook Ads for India", 
    speaker: "Rohan Sharma", 
    thumbnail: "https://d24fzeiqvvundc.cloudfront.net/media_uploads/8b3c92a18490d218134a0003e81be003.jpeg" 
  },
  { 
    title: "Sourcing Mastery: Beyond the Basics", 
    speaker: "Anjali Gupta", 
    thumbnail: "https://d24fzeiqvvundc.cloudfront.net/media_uploads/dce0c4f25e88e56859a33a331da75c18.jpeg" 
  },
  { 
    title: "Inventory Management for Scale", 
    speaker: "Vikram Singh", 
    thumbnail: "https://d24fzeiqvvundc.cloudfront.net/media_uploads/312e1665903515fd1aa3187e5b5279da.jpeg" 
  },
  { 
    title: "The Art of Private Labeling", 
    speaker: "Sarah Khan", 
    thumbnail: "https://d24fzeiqvvundc.cloudfront.net/media_uploads/ca1630f69a6d7e373a88f5e4ae256d21.png" 
  },
  { 
    title: "COD Optimization Strategies", 
    speaker: "Amit Patel", 
    thumbnail: "https://d24fzeiqvvundc.cloudfront.net/media_uploads/7cfdc6c9de34288c70514825326391e0.png" 
  }
];
    ...
    <div className="space-y-8 pb-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex flex-col gap-2">
        <div className="flex items-center gap-2 text-primary">
          ...
          <span className="text-xs font-black uppercase tracking-[0.2em]">Elite Learning</span>
        </div>
        <h1 className="text-3xl font-black tracking-tight text-foreground">Webinars Hub</h1>
        <p className="text-muted-foreground text-sm max-w-xl">
          Learn scaling secrets and market-proven strategies directly from the top 1% of eCommerce founders in the vF Community.
        </p>
      </div>
          ...
          <div className="absolute bottom-6 left-6 right-6 flex items-end justify-between">
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <span className="px-2 py-0.5 rounded-md bg-emerald-500 text-white text-[10px] font-black uppercase tracking-wider">New Drop</span>
              ...
              <div className="flex items-center gap-2 text-white/70 text-sm">
                <span className="font-bold text-white">{featuredWebinar.speaker}</span>
                <span>•</span>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="rounded-2xl border-2 border-dashed border-muted-foreground/20 flex flex-col items-center justify-center p-6 text-center space-y-2 opacity-60">
            ...
            <span className="text-xs font-black uppercase tracking-wider">Next Session</span>
            <p className="text-[10px] font-medium text-muted-foreground">Stay tuned for more elite insights</p>
          </div>
        </div>
      </div>
    </div>
